...
const Data = () => {
  return (
    <div className="home_data">
        <h1 className="home_title">Ashish Kumar
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home_subtitle">Engineering Student</h3>
        <p className="home_description">I'm a computer science engineering student studying in VIT Bhopal University.</p>
