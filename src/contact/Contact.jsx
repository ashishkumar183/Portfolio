...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs
        .sendForm('service_6hfm9j5', 'template_jn8kpj8', form.current, {
          publicKey: 'H9G1tSykQLv9YKR2U',
        })
        e.target.reset()
    };
  return (
                ...
                <div className="contact_info">
                    <div className="contact__card">
                        ...
                        <a href="" className="contact__button">Write me 
                            <i className="bx bx-right-arrow-alt contact__contact-button-icon"></i>
                        </a>
                    </div>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">XXXX-XXX-XXX</span>
                        <a href="" className="contact__button">Write me {""}
                            <i className="bx bx-right-arrow-alt contact__contact-button-icon"></i>
                        </a>
                    </div>
            ...
            <div className="contact_content">
                ...
                <form ref={form} onSubmit={sendEmail} className="contact_form">
                    <div className="contact_form-div">
                        ...
                        <input type="text" 
                            name="name"
                            className='contact_form-input' placeholder='Insert your name' />
                    </div>
                    <div className="contact_form-div">
                        <label className="contact_form-tag">Mail</label>
                        <input type="email" 
                            name="email"
                            className='contact_form-input' placeholder='Insert your email' />
                    </div>
                    ...
                    <button className="button button_flex">
                        <div className="hello">Send Meassage</div>
                        <svg
                  class="button__icon"
